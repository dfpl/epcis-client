...
import org.oliot.epcis.client.document_builder.AggregationEventBuilder;
...
public class CaptureAggregationEvent {
	...
	public void captureTestMinimal1() throws ValidationException, ParseException {
		...
		client.addAggregationEvent(new AggregationEventBuilder("2020-10-15T20:33:31.116Z", "-09:00",ActionType.OBSERVE).build());
	...
	public void captureTestMinimal2() throws ValidationException, ParseException {
		...
		client.addAggregationEvent(new AggregationEventBuilder(System.currentTimeMillis(), "Z",ActionType.OBSERVE).build());
	...
	public void captureTestParentID() throws ValidationException, ParseException {
		...
		client.addAggregationEvent(new AggregationEventBuilder("2020-10-15T20:33:31.116Z", "-09:00",ActionType.OBSERVE)
	...
	//childEPCs test
	public void captureTestChildEPCs() throws ValidationException, ParseException {
		...
		client.addAggregationEvent(new AggregationEventBuilder("2020-10-15T20:33:31.116Z", "-09:00",ActionType.OBSERVE)
				.setChildEPCList(List.of("urn:epc:id:sgtin:0614141.107346.2017", "urn:epc:id:sgtin:0614141.107346.2018"))
				.build());
	...
	public void captureTestReadPoint() throws ValidationException, ParseException {
		...
		client.addAggregationEvent(new AggregationEventBuilder("2020-10-15T20:33:31.116Z", "-09:00",ActionType.OBSERVE)
				.setReadPoint("urn:epc:id:sgln:0037000.00729.8202")
				.build());
	...
	public void captureTestBizLocation() throws ValidationException, ParseException {
		...
		client.addAggregationEvent(new AggregationEventBuilder("2020-10-15T20:33:31.116Z", "-09:00",ActionType.OBSERVE)
				.setBizLocation("urn:epc:id:sgln:0037000.00729.8202")
				.build());
